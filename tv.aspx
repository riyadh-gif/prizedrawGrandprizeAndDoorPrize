<%@ Page Title="TV 32 Inch" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tv.aspx.cs" Inherits="pricedraw._tv" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <!-- Tombol untuk melakukan pengundian hadiah secara acak -->
    <div class="center-button">
        <asp:Button ID="btnResult" runat="server" Text="Result" CssClass="btn btn-success" OnClick="BtnResultTV_Click" />
        <asp:Button ID="btnShuffle" runat="server" Text="Shuffle" CssClass="btn btn-primary" OnClick="BtnShuffleTV_Click" />
    </div>

    <!-- Tabel untuk menampilkan hasil pengundian hadiah -->
    <asp:GridView ID="MyGridViewTV" runat="server" CssClass="table-pastel" AutoGenerateColumns="false">
        <Columns>
    ...
    <div id="popupContainer" class="popup-container" style="display: none;">
        <div class="popup">
            ...
            <asp:Button ID="BtnClosePopup" runat="server" Text="Close" CssClass="popup-button" OnClick="BtnClosePopupTV_Click" />
        </div>
    </div>
