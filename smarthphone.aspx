<%@ Page Title="Smarthphone" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="smarthphone.aspx.cs" Inherits="pricedraw._smarthphone" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <!-- Tombol untuk melakukan pengundian hadiah secara acak -->
    <div class="center-button">
        <asp:Button ID="btnResult" runat="server" Text="Result" CssClass="btn btn-success" OnClick="BtnResult1_Click" />
